...
@Component
@ConditionalOnProperty(name = "twitter-to-kakfa-service.enable-mock-tweets", havingValue = "true")
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waitting new status to create!!");
        }
    }
